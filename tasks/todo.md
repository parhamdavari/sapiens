...
- [ ] T2: Fetch the Wiktionary idiom category dump
...
- [ ] T3: Reference scores for calibration passages
...
- [ ] T4: Spike one headless CLI reply
...
- [ ] T5: Extract `scripts/lib/text.mjs` and fix the splitter
...
- [ ] T6: Golden snapshots for `toProse`
...
- [ ] T10: Word-boundary matcher and corpora
...
- [ ] T11: New report and `--markdown` output
...
- [ ] T12: Recalibrate thresholds and regenerate docs
...
- [ ] T13: Findings checklists and recall scorer
...
- [ ] T15: One edit through the D9 protocol
